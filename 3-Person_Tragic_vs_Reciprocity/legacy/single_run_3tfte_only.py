...
def run_pairwise_simulation_single(agents, num_rounds):
    """Runs a single pairwise tournament and returns detailed data."""
...
def run_nperson_simulation_single(agents, num_rounds):
    """Runs a single N-Person simulation and returns detailed data."""
    all_coop_history = {agent.agent_id: [] for agent in agents}
    score_history = {agent.agent_id: [] for agent in agents}
    cumulative_scores = {agent.agent_id: 0 for agent in agents}
...
if __name__ == "__main__":
    ...
    pairwise_coop, pairwise_scores = run_pairwise_simulation_single(agents, NUM_ROUNDS)
    ...
    nperson_coop, nperson_scores = run_nperson_simulation_single(agents, NUM_ROUNDS)
