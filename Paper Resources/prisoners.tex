...
% --- Figure Placeholder ---
% You should create this figure by taking the top-right subplot from your "1 Enhanced QL Neighbourhood - Cooperation Rates" image
% and the top-right subplot from your "1 Enhanced QL Neighbourhood - Cumulative Scores" image and combining them.
\begin{figure}[ht]
    \centering
...
% --- Figure Placeholder ---
% You should create this figure by taking the top-left subplot ("1 EQL + 2 AllD") and the middle-right subplot ("1 EQL + 1 AllD + 1 AllC")
% from your "1 Enhanced QL Neighbourhood - Cooperation Rates" image and placing them side-by-side.
\begin{figure}[ht]
    \centering
